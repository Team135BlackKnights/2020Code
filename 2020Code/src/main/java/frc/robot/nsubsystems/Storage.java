...
public class Storage extends SubsystemBase implements RobotMap.INTAKE {
  ...
  public void intakeBallCount() {
    // Counts up on state change from False to True by making sure that there was a
    // change and that it then is positive
  ...
  public void autoMoveBalls() {
    ...
    // Warning was coming from the turret not existing yet, so I commented it out and had it just run
